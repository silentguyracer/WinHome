...
class TestDenoPlugin(unittest.TestCase):
    ...
    def test_apply_empty_config(self):
        ...
        self.assertEqual(result, {"requestId": "req-456", "success": True, "changed": False, "data": None})
    ...
    def test_apply_config_no_changes_needed(self, mock_write, mock_read, mock_path):
        ...
        self.assertEqual(result, {"requestId": "req-789", "success": True, "changed": False, "data": None})
